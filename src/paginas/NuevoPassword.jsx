...
export const NuevoPassword = () => {
  ...
  //Esta onda se activa cuando el correo esta nitido y hay que mandarlo
  ...
  return (
    ...
    <div className="mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white">
        {msg && <Alerta
                alerta={alerta}
        />}
        {tokenValido && (//Esta onda muestra todo esto si el token es true
        <>
