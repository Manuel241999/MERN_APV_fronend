...
const Registrar = () => {
  ...
  const handleSubmit = async e => {
    ...
    //Crear el usuario en la API <----------------CONSUMIENDO EL BACKEND------------------
    try {
      await clienteAxios.post('/veterinarios', {nombre,email,password});//Esta onda es como tener: `${import.meta.env.VITE_BACKEND_URL}/api/veterinarios`;
      setAlerta({
...
//-----------------------------------------------------------------------------------------
  const {msg} = alerta;//Esta variables solo es para que se quite el mensaje de error
