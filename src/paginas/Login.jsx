...
import { Link, useNavigate } from "react-router-dom"//Para ganar performance
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setAuth(data)//Esto sirve para reenviar el object para que luego de haber cerrado session me deje hacerlo despues
      navigate('/admin')//Me redirige de manera a donde yo quiera pero gracias al navigar
    } catch (error) {
      setAlerta({
  ...
  return (
   <>
        ...
        {msg && <Alerta   //En caso de que exista el msg, vamos a mostrar la alerta
